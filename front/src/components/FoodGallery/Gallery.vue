    ...
    <div class="container">
      <div class="row">
        <div class="col-md-offset-2 col-md-8 col-sm-12 text-center">
          <h1 class="heading">What is there to eat?</h1>
          <hr>
        </div>
        ...
        <div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
          ...
          <div>
            <h3>Sushi</h3>
            <span>Soy souce / Rice / Avocado</span>
          </div>
        </div>
        <div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.9s">
          ...
          <div>
            <h3>Risotto with salmon</h3>
            <span>Salmon / Curry / Asparagus</span>
          </div>
          ...
          <div>
            ...
            <span>Prosciutto / Parmesan / Green</span>
          </div>
        </div>
      </div>
    </div>
